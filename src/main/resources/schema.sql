...
CREATE TABLE "order"(
                        ...
                        source_office_id INT REFERENCES "office"(office_id) NOT NULL,
...
CREATE TABLE "shipment"(
                           ...
                           source_office_id INT REFERENCES "office"(office_id),
                           destination_office_id INT REFERENCES "office"(office_id)
);
...
CREATE TABLE "shipment_status_history"(
                                       shipment_status_history_id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
                                       shipment_id INT REFERENCES "shipment"(shipment_id) NOT NULL,
                                       shipment_status_id INT REFERENCES "shipment_status"(shipment_status_id) NOT NULL,
                                       driver_id INT REFERENCES "employee"(employee_id) NOT NULL,
                                       changed_at TIMESTAMP NOT NULL
);
